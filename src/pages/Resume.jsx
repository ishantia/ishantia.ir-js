...
export default function Resume() {
  ...
  return (
    <section
      className={`section resume-page lang-${lang}`}
      id="resume"
      dir={t.dir}
    >
              ...
              {t.experience.map((item) => (
                ...
                >
                  <div className="resume-timeline-head">
                    <h3>{item.title}</h3>
                    <span className="resume-timeline-period">
                      {item.period}
                    </span>
                  </div>
