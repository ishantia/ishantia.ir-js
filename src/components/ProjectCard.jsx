...
export default function ProjectCard({ project, index }) {
  ...
  const safeLink = LINK_PATTERN.test(project.link || "") ? project.link : "https://github.com/ishantia";
  ...
  return (
    ...
    >
      ...
      <a href={safeLink} className="project-link" target="_blank" rel="noopener noreferrer" aria-label={`View ${name}`}>
