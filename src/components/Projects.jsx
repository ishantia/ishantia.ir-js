...
const PROJECT_FALLBACK = [
  {
    ...
    description: "Small utilities and learning projects built while exploring practical software ideas.",
    tags: ["GitHub", "Learning", "Tools"],
    link: "https://github.com/ishantia"
  },
  {
    name: "Android playground",
    description: "Creative Android experiments focused on understanding apps, interfaces, and device behavior.",
    tags: ["Android", "Java", "Mobile"],
    link: "https://github.com/ishantia"
  },
  {
    name: "Automation and API work",
    description: "Python and Telegram API experiments for bots, scripts, and connected workflows.",
...
export default function Projects() {
  const projects = Array.isArray(projectsData) && projectsData.length ? projectsData : PROJECT_FALLBACK;
      ...
      <div className="container">
        ...
        <noscript>
          <p className="section-copy">
            Enable JavaScript to view my projects, or visit my <a href="https://github.com/ishantia">GitHub profile</a>{" "}
            directly.
          </p>
        </noscript>
      </div>
